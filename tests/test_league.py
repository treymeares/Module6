...
from source import Competition
...
class LeagueTests(unittest.TestCase):
    ...
    def test_adding_duplicate_teams(self):
        t = Team(1, "Ice Maniacs")
        t2 = Team(1, "Big Dogs")
        league = League(1, "AL State Curling League")
        self.assertNotIn(t, league.teams)
    ...
    def test_member_in_team_return_team(self):
        t1 = Team(1, "t1")
        t2 = Team(2, "t2")
        t3 = Team(3, "t3")
        ...
        self.assertIn(tm1, t1.members)
        self.assertIn(tm2, t1.members)
        self.assertNotIn(tm3, t1.members)
    ...
    def test_string_output_of_team(self):
        c = Competition(1, [], "Local tourney", None)
        d = Competition(2,[], "Free Runs", None)
        league = League(13, "AL State Curling League")
        league.add_competition(c)
        league.add_competition(d)
        t1 = Team(1, "t1")
        t2 = Team(2, "t2")
        t3 = Team(3, "t3")
        league.add_team(t1)
        ...
        self.assertEqual("AL State Curling League: 3 teams, 2 competitions", str(league))
        self.assertNotEqual("AL State Curling League: 3 teams, 4 competitions", str(league))
